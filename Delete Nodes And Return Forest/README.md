<h3><a href=https://leetcode.com/problems/delete-nodes-and-return-forest/>Delete Nodes And Return Forest</a></h3>
<p><p>Given the <code>root</code> of a binary tree, each node in the tree has a distinct value.</p>
