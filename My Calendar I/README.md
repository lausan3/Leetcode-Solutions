<h3><a href=https://leetcode.com/problems/my-calendar-i/>My Calendar I</a></h3>
<p><p>You are implementing a program to use as your calendar. We can add a new event if adding the event will not cause a <strong>double booking</strong>.</p>
