<h3><a href=https://leetcode.com/problems/my-calendar-iii/>My Calendar III</a></h3>
<p><p>A <code>k</code>-booking happens when <code>k</code> events have some non-empty intersection (i.e., there is some time that is common to all <code>k</code> events.)</p>
