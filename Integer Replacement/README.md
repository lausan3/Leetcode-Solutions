<h3><a href=https://leetcode.com/problems/integer-replacement/description/>Integer Replacement</a></h3>
<p><p>Given a positive integer <code>n</code>,&nbsp;you can apply one of the following&nbsp;operations:</p>
