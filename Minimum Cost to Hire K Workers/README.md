<h3><a href=https://leetcode.com/problems/minimum-cost-to-hire-k-workers/>Minimum Cost to Hire K Workers</a></h3>
<p><p>There are <code>n</code> workers. You are given two integer arrays <code>quality</code> and <code>wage</code> where <code>quality[i]</code> is the quality of the <code>i<sup>th</sup></code> worker and <code>wage[i]</code> is the minimum wage expectation for the <code>i<sup>th</sup></code> worker.</p>
