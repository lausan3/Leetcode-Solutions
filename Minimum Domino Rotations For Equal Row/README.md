<h3><a href=https://leetcode.com/problems/minimum-domino-rotations-for-equal-row/>Minimum Domino Rotations For Equal Row</a></h3>
<p><p>In a row of dominoes, <code>tops[i]</code> and <code>bottoms[i]</code> represent the top and bottom halves of the <code>i<sup>th</sup></code> domino. (A domino is a tile with two numbers from 1 to 6 - one on each half of the tile.)</p>
