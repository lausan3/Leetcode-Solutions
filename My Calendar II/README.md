<h3><a href=https://leetcode.com/problems/my-calendar-ii/>My Calendar II</a></h3>
<p><p>You are implementing a program to use as your calendar. We can add a new event if adding the event will not cause a <strong>triple booking</strong>.</p>
